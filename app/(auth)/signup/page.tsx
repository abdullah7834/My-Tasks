    ...
    <div className="min-h-screen bg-zinc-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-600 mt-2">Start managing your tasks efficiently</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8">
          ...
          <button
            type="button"
            className="w-full flex items-center justify-center gap-3 py-3.5 border border-zinc-200 hover:bg-zinc-50 rounded-2xl font-medium transition-colors text-black cursor-pointer"
          >
